...
INSERT INTO `ordem_cliente` VALUES (1,'Negão','Manutenção'),(2,'Bias','PCP'),(3,'lucas','TI'),(4,'Matheus','Vendas'),(5,'Thiago','PCP'),(6,'Porteiro','Portaria'),(7,'Fabinho','Fogão'),(8,'Andersom','Manutenção'),(9,'Marcão','Manutenção');
