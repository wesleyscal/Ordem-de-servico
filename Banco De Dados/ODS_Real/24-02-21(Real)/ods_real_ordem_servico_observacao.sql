...
INSERT INTO `ordem_servico_observacao` VALUES (1,2,'Falta Fechar a porta do Swtch.','2020-09-08'),(2,3,'Planilha esta no Desktop com o nome \"Lucão\",','2020-09-09'),(3,4,'ok Entregue','2020-09-09'),(4,5,'Um deles parou.','2020-09-09'),(5,7,'Obeservar se esta com lentidão, Troquei a fonte e parece que parou de travar.','2020-09-15'),(6,10,'Dia 26/09/20 testar o nobreak que chegou,\r\n\r\nSem nada ligado ele fica a 81v,\r\nCom 1 pc ligado ele vai para 85v,','2020-09-24'),(7,10,'Não foi possivel dia 26/09, remarcar outra data','2020-09-28'),(8,11,'Tranformador Comprado, falta instalação','2020-10-05'),(9,10,'Hoje o Nobreak 01 quebrou, Testei o nobreak que estava para testar(03) e ele esta 100%, foi remanejado do nobreak 01 para 03, Mandar nobreak 01 para o concerto','2020-10-06'),(10,14,'Chegou o nobreak novo','2020-10-13'),(11,14,'Nobreak Colocado falta plugar a bateria','2020-10-13'),(12,10,'Nobreak No concerto, esperando plug da bateria para o nobreak 4','2020-10-13'),(13,8,'Falta Arrumar o Dominio e Ativar o windows','2020-10-16'),(14,11,'Intalação no Compras ok, Falta Fogão e almoxarifado','2020-10-20'),(15,10,'Nobreak colocado, falta cabo de bateria\r\n','2020-10-20'),(16,23,'Esperando Sr. Pedro levar a infocat','2021-01-25'),(17,9,'Feito o pedido de comprar !!','2021-02-05'),(18,23,'Aguardando infocat','2021-02-05');
