CREATE DATABASE  IF NOT EXISTS `ods_teste` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `ods_teste`;
...
INSERT INTO `ordem_servico_observacao` VALUES (1,2,'Falta Fechar a porta do Swtch.','2020-09-08'),(2,3,'Planilha esta no Desktop com o nome \"Lucão\",','2020-09-09'),(3,4,'ok Entregue','2020-09-09'),(4,5,'Um deles parou.','2020-09-09'),(5,7,'Obeservar se esta com lentidão, Troquei a fonte e parece que parou de travar.','2020-09-15'),(12,11,'Teste','2020-09-21'),(13,11,'Teste Nova','2020-09-21'),(15,12,'Teste 01','2020-09-23'),(18,12,'Bosta','2020-09-24'),(21,11,'teste 03','2020-09-24'),(22,12,'a','2020-09-24');
...
-- Dump completed on 2020-10-06  9:44:14
